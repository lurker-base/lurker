...
def create_signal_html(symbol, pair, entry, target, stop, confidence, rationale, validated_by="Stéphane"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--validator", default="Stéphane", help="Who validated")

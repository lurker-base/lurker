...
def process_file(filepath):
    ...
    new_nav = NEW_NAV
    for key in ['active_lurker', 'active_token', 'active_story', 'active_live', 'active_proof', 'active_predictions', 'active_subscribe']:
        if key == active:
...
def main():
    ...
    print(f"\nUpdated {len(html_files)} files with 'story' navigation")
